 ...
 * 
 * This file contains the extra functions declarations that allow to interact with the count variable of the timer.c file, instead of directly accessing it using the extern keyword.
 */
