...
#define CURSOR_BUTTON_LEFT_X_POSITION SCREEN_CENTER_X - 244 / 2 
#define CURSOR_BUTTON_RIGHT_X_POSITION SCREEN_CENTER_X + 214 / 2
...
#define CURSOR_BUTTON_BOTTOM_SINGLE_Y_POSITION (SCREEN_STARTING_Y + 400 + 90)
#define CURSOR_BUTTON_BOTTOM_MULTI_Y_POSITION (SCREEN_STARTING_Y + 500 + 90)
#define CURSOR_BUTTON_BOTTOM_EXIT_Y_POSITION (SCREEN_STARTING_Y + 700 + 90)
